srcdir = /opt/php-7.0.16/ext/uniqueid
builddir = /opt/php-7.0.16/ext/uniqueid
top_srcdir = /opt/php-7.0.16/ext/uniqueid
top_builddir = /opt/php-7.0.16/ext/uniqueid
EGREP = /bin/grep -E
SED = /bin/sed
CONFIGURE_COMMAND = './configure' '--with-php-config=/usr/local/php7_1/bin/php-config'
CONFIGURE_OPTIONS = '--with-php-config=/usr/local/php7_1/bin/php-config'
SHLIB_SUFFIX_NAME = so
SHLIB_DL_SUFFIX_NAME = so
ZEND_EXT_TYPE = zend_extension
RE2C = exit 0;
AWK = gawk
shared_objects_uniqueid = uniqueid.lo incr.lo semop.lo
PHP_PECL_EXTENSION = uniqueid
PHP_MODULES = $(phplibdir)/uniqueid.la
PHP_ZEND_EX =
all_targets = $(PHP_MODULES) $(PHP_ZEND_EX)
install_targets = install-modules install-headers
prefix = /usr/local/php7_1
exec_prefix = $(prefix)
libdir = ${exec_prefix}/lib
prefix = /usr/local/php7_1
phplibdir = /opt/php-7.0.16/ext/uniqueid/modules
phpincludedir = /usr/local/php7_1/include/php
CC = cc
CFLAGS = -g -O2
CFLAGS_CLEAN = $(CFLAGS)
CPP = cc -E
...
EXTENSION_DIR = /usr/local/php7_1/lib/php/extensions/no-debug-non-zts-20151012
PHP_EXECUTABLE = /usr/local/php7_1/bin/php
EXTRA_LDFLAGS =
EXTRA_LIBS =
INCLUDES = -I/usr/local/php7_1/include/php -I/usr/local/php7_1/include/php/main -I/usr/local/php7_1/include/php/TSRM -I/usr/local/php7_1/include/php/Zend -I/usr/local/php7_1/include/php/ext -I/usr/local/php7_1/include/php/ext/date/lib
LFLAGS =
LDFLAGS =
SHARED_LIBTOOL =
